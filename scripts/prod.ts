...
async function main() {
  ...
  try {
    ...
    for (const course of courses) {
      console.log(`  → Seeding units for course ${course.id}`);
      ...
      for (const unit of units) {
        console.log(`    → Seeding lessons for unit ${unit.id}`);
        ...
        for (const lesson of lessons) {
          console.log(`      → Seeding challenges for lesson ${lesson.id}`);
          ...
          for (const challenge of challenges) {
            console.log(`        → Seeding options for challenge ${challenge.id}`);
